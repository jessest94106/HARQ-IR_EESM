...
simParameters.SNRIn = [linspace(4.79,6, 5)]; % SNR range (dB)
...
if simParameters.PDSCH.NumCodewords > 1                             % Multicodeword transmission (when number of layers being > 4)
    ...
    simParameters.PDSCHExtension.TargetCodeRate = (772/1024)/4;         % Code rate used to calculate transport block sizes
end
